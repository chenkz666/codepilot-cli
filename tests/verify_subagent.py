...
from codepilot.agents.fork import FORK_BOILERPLATE_TAG, ForkError, build_forked_messages
...
def verify_fork():
    ...
    has_placeholder = any(
        msg.tool_results and msg.tool_results[0].content == "interrupted" for msg in forked2.history
    )
...
def verify_notification():
    ...
    from codepilot.agents.task_manager import BackgroundTask
