...
class TestLoadSkillTool:
    ...
    async def test_load_existing_skill(self) -> None:
        from codepilot.tools.load_skill import LoadSkill, LoadSkillParams
...
class TestAgentSkillIntegration:
    def test_fork_context_uses_current_conversation(self) -> None:
