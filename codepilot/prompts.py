"""CodePilot 的系统提示词（system prompt）构建。"""
...
IDENTITY_SECTION = PromptSection(
    ...
    priority=0,
    content=(
        "You are CodePilot, an AI programming assistant running in the terminal. "
...
def detect_environment(work_dir: str) -> EnvironmentContext:
    """检测当前运行环境并返回 EnvironmentContext。"""
...
def build_system_prompt(
    ...
    if coordinator_mode:
        from codepilot.teams.coordinator import get_coordinator_system_prompt
