...
PROJECT_AGENTS_DIR = ".codepilot/agents"
USER_AGENTS_DIR = "~/.codepilot/agents"
...
class AgentLoader:
    ...
    def _load_builtins(self) -> list[AgentDef]:
        results: list[AgentDef] = []
        try:
            builtins_pkg = importlib.resources.files("codepilot.agents.builtins")
        ...
        for item in builtins_pkg.iterdir():
            ...
            try:
                ...
                from codepilot.agents.parser import parse_frontmatter, _validate_agent_meta
