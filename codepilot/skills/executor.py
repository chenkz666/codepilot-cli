...
from codepilot.skills.parser import SkillDef, substitute_arguments
...
class SkillExecutor:
    ...
    async def execute_fork(self, skill: SkillDef, args: str) -> str:
        ...
        from codepilot.agent import Agent as AgentClass, StreamText, LoopComplete, ErrorEvent
    ...
    def _build_fork_context(self, mode: str) -> list[Message]:
        ...
        conversation = self.agent._current_conversation
