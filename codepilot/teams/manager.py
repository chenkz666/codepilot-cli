...
from codepilot.teams.backend_detect import detect_backend
...
from codepilot.teams.progress import TeammateProgress
from codepilot.teams.registry import AgentNameRegistry
from codepilot.teams.shared_task import SharedTaskStore
from codepilot.teams.spawn_inprocess import InProcessTeammateHandle
    ...
    def _kill_pane(self, pane_id: str, backend_type: str) -> None:
        try:
            if backend_type == BackendType.TMUX.value:
                from codepilot.teams.spawn_tmux import kill_pane
