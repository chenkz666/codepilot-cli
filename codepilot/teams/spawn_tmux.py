...
def build_cli_command(
    ...
    env_parts = [
        f"CODEPILOT_TEAM_NAME={team_name}",
        f"CODEPILOT_TEAMMATE_NAME={teammate_name}",
    ]
    if mailbox_dir:
        env_parts.append(f"CODEPILOT_MAILBOX_DIR={mailbox_dir}")
...
def spawn_tmux_teammate(
    ...
    # Create a dedicated tmux window rather than splitting the current pane.
