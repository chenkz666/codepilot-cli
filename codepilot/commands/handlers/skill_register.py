...
from codepilot.commands.registry import Command, CommandContext, CommandRegistry, CommandType
...
def register_skill_commands(
    ...
    registered_names = _REGISTERED_SKILL_NAMES.setdefault(registry, set())
    ...
    for skill_name, skill_desc in loader.get_catalog():
        ...
        def make_handler(name: str) -> Callable[[CommandContext], Awaitable[None]]:
            ...
            async def handler(ctx: CommandContext) -> None:
                ...
                if skill.mode == "fork":
                    ...
                    ctx.ui.add_system_message(f"skill({name})\nSuccessfully loaded skill")
